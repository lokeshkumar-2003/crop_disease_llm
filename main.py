...
async def predict_and_remedy(
    ...
    language: str = Form("english")  # Added language parameter with default
):
    ...
    try:
        ...
        total_pesticide_required = round(
            final_dosage * total_water_required, 2
        )
        ...
        context = {
            ...
            "language": language  # Pass language to LLM service
        }
